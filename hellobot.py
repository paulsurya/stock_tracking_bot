...
async def start_command(update:Update, context:ContextTypes.DEFAULT_TYPE):
    await bot.sendMessage('Welcome to *Trackify* ! I\'m your go-to bot for real-time stock and forex market updates. Want to track a specific stock or currency? Just send me its name or ticker symbol. Need help? Type \'/help\' for a list of commands')
